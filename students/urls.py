...
urlpatterns = [
    ...
    # Nhập điểm nhanh từ trang Detail
    ...
    # ==========================================
    # 3. QUẢN LÝ MASTER DATA (TÀI KHOẢN, KHOA, CHỨNG CHỈ)
    # ==========================================
    ...
    # ==========================================
    # 4. QUẢN TRỊ ĐỢT THI, LỊCH THI & ĐIỂM SỐ
    # ==========================================
    ...
    # --- Import LỊCH THI (Bổ sung đủ 3 môn) ---
